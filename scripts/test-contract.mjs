...
const expectedOperations = {
  ...
  "desktop.vision": ["click", "find", "release", "status"],
...
try {
  ...
  if (capabilities?.server?.version !== "0.8.2" || Object.keys(capabilities.tools || {}).length !== 19) {
  ...
  console.log("PASS: v0.8.2 exposes exactly 19 compact domain tools and no legacy flat tools");
