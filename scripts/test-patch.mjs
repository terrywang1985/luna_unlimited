...
const client = new Client({ name: "luna-patch-mcp-test", version: "0.8.1" });
...
try {
  ...
  if (capabilities.server.version !== "0.8.1" || capabilities.features.patch !== true) {
...
`;
  ...
  console.log("PASS: MCP advertises v0.8.1 atomic code.patch capability");
