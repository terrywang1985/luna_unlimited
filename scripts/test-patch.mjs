...
const client = new Client({ name: "luna-patch-mcp-test", version: "0.5.0" });
...
try {
  ...
  if (capabilities.server.version !== "0.5.0" || capabilities.features.patch !== true) {
...
`;
  ...
  console.log("PASS: MCP advertises v0.5.0 atomic apply_patch capability");
